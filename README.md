...
`Hawk Eye`: Calculate accuracy,winrate difference,score difference,blunder move based on the difference of engine candidates and actually move,and display in chart.
